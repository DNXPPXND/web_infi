...
const Course_System_analysis_onsite = () => {
  return (
    <>
        ...
        <div class="rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4">
            <div class="font-bold text-xl mb-2">
              System Analysis{" "}
              <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 ml-3">
                #System Analysis
              </span>
            </div>
            ...
            <div className="flex justify-center mt-10">
              <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                <a href="/onsite-course" target="_blank">
...
export default Course_System_analysis_onsite;
