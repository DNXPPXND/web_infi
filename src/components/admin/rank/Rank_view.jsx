...
export default function Rank_view() {
  ...
  const handleUpdate = (rank_id) => {
    window.location = `/admin/update/rank/${rank_id}`;
  };
                  ...
                  <TableBody>
                    {items.map((row, index) => (
                      ...
                      >
                        ...
                        <TableCell align="center">{row.rank_name}</TableCell>
                        <TableCell align="center">{row.rank_point}</TableCell>
                        <TableCell align="center">
                        ...
                        <TableCell align="center">
                          ...
                          >
                            ...
                            <Button onClick={() => handleDelete(row.rank_id)}>
                              ลบ
                            </Button>
                          </ButtonGroup>
                        </TableCell>
