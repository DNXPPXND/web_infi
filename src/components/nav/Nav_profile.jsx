        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            <li>
              ...
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-yellow-500 transition duration-75"
                  aria-hidden="true"
                ...
                <span class="ml-3 text-black">ข้อมูลการเรียน</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-green-500 transition duration-75"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
                ...
                <span class="ml-3 text-black">คอร์สเรียนของฉัน</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-cyan-500 transition duration-75"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
            ...
            <li>
              ...
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-red-500 transition duration-75"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
